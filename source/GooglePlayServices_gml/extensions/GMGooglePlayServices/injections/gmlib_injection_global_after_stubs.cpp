...
void Init_GMGooglePlayServices()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMGooglePlayServices.ext");
    if (libHandle)
    {
...
void Startup_GMGooglePlayServices()
{
...
void Shutdown_GMGooglePlayServices()
{
    if (!isInitialized) return;
