...
public interface GMGooglePlayServicesInterface {
    ...
    public void gpgs_player_load(String player_id, boolean force_reload, GMFunction callback);
    public void gpgs_friends_load(boolean force_reload, double max_results, GMFunction callback);
    public void gpgs_friends_load_more(GMFunction callback);
    public void gpgs_friends_load_with_consent(boolean force_reload, double max_results, GMFunction callback);
    public void gpgs_player_profile_show(String player_id);
    public void gpgs_player_search_show(GMFunction callback);
