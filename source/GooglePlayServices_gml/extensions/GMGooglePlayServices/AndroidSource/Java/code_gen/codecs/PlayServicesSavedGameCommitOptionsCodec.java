...
public final class PlayServicesSavedGameCommitOptionsCodec {
    private PlayServicesSavedGameCommitOptionsCodec()
    {
    }
    public static PlayServicesSavedGameCommitOptions read(ByteBuffer b)
    {
