...
public final class GPGSPlayerInfoCodec {
    private GPGSPlayerInfoCodec()
    {
    }
    public static GPGSPlayerInfo read(ByteBuffer b)
    {
        ...
        return new GPGSPlayerInfo(player_id, display_name, title, icon_image_uri, hi_res_image_uri);
    }

    public static void write(ByteBuffer b, GPGSPlayerInfo obj)
    {
