/// @description Draw account info

// Early exit if we are not signed in.
if (! GooglePlayServices_IsSignedIn()) return;
...
draw_text(x + 160, y, "Account Info:");
	
var info = accountInfo;
	
// We check if 'info' is a valid struct
// NOTE: Data is retreived in function call 'accountInfoGet'
